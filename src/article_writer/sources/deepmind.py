...
# deepmind.google/blog/rss is a Google-hosted feed; structure may deviate from
# standard RSS 2.0 (e.g. Atom link elements or custom namespaces).
_FEED = "https://deepmind.google/blog/rss"
